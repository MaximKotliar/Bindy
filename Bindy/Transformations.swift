...
public extension Observable {
    ...
    public func debounced(_ delay: TimeInterval) -> Observable<T> {
        let debounced = Observable<T>(value, options: [.comparisonClosure: comparisonClosure as Any])
    ...
    public func throttled(_ delay: TimeInterval) -> Observable<T> {
        let throttled = Observable<T>(value, options: [.comparisonClosure: comparisonClosure as Any])
